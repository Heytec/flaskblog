...
def home():
    ...
    post=Post.query.order_by(Post.date_posted.desc()).paginate(per_page=1,page=page)
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f'Account has being  created for{form.username.data}!', 'success')
...
def account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('you account submitted','success')
...
def update_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your Post has being update!','success')
